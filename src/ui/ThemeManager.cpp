...
QString ThemeManager::generateApplicationStyleSheet() const {
    ...
    return QStringLiteral(
        ...
        "QTabBar::tab { "
        "   background-color: %1; color: %11; padding: 7px 16px; margin-right: 4px; "
        "   border-top-left-radius: 7px; border-top-right-radius: 7px; border: 1px solid %12; border-bottom: none; "
        "   font-weight: 500; font-size: 12px; "
        "}"
        "QTabBar::tab:selected { "
        "   background-color: %3; color: %7; font-weight: 600; border: 1px solid %4; border-bottom: 1px solid %3; "
        "}"
        "QTabBar::tab:hover:!selected { background-color: %5; color: %9; border-color: %4; }"
